...
export default function ImpactMapPage() {
  const { eapState, roads } = useDemoStore();
  ...
  return (
    <div className="mx-auto flex max-w-6xl flex-col gap-6">
      <PageHeader
        ...
        description="No basemap tiles are fetched — this view is fully offline. Flood extent, bridges, shelters, roads and critical assets are drawn from bundled fixture geometry only. Visible to every role."
